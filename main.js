...
require('./SiFz.js')
nocache('./SiFz.js', module => console.log(`${module} telah di update!`))
...
console.log(color('? Ortu                '))
console.log(color('? semuanya                 '))
console.log(color('? SiFz                      '))
console.log(color('  >>>>>>>>>>>>>>>??????>>||||||||||||'))
    console.log(banner)
    simple.on('qr', () => {
    ...
    simple.on('chat-update', async (message) => {
        require('./SiFz.js')(simple, message, _welkom)
    })
...
function nocache(module, cb = () => { }) {
    console.log('Module', `'${module}'`, 'Diawasi Oleh SiFz')
